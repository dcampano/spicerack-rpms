...
BuildRequires:  readline libyaml libyaml-devel readline-devel ncurses ncurses-devel gdbm gdbm-devel glibc-devel tcl-devel gcc unzip openssl-devel db4-devel byacc make libffi-devel git
Requires:       libyaml
Source0:        ftp://ftp.ruby-lang.org/pub/ruby/%{rubymajorver}/ruby-%{rubyver}.tar.gz
...
./configure --prefix=%{_prefix} --disable-install-doc --enable-shared --disable-rpath --enable-load-relative
